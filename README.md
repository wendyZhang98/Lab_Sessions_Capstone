...
- **Lab 2 – Data & Environment Management**  
  Best practices for organizing projects, managing Python environments, and preparing data for large-scale ML tasks.  

- **Lab 3 – NLP Pipeline (Yelp Reviews)**  
...
- **Development Tools:** Git, VS Code Remote, Conda  
...
- Train and monitor **NLP and CV models** efficiently with GPU and mixed precision.  
- Apply **best practices** in job scheduling, logging, and model performance visualization.  
